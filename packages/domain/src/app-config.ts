...
export const appConfigSchema = z.object({
  ...
  lexicalSearchMode: z.enum(['content_plain', 'weighted_websearch']).default('weighted_websearch'),
...
export const partialAppConfigSchema = z.object({
  ...
  rerankerThreshold: appConfigShape.rerankerThreshold.removeDefault().optional(),
  hybridEnabled: appConfigShape.hybridEnabled.removeDefault().optional(),
  lexicalSearchMode: appConfigShape.lexicalSearchMode.removeDefault().optional(),
